...
| **importedVariables**          | string[]                                                                                              | The environment variables to import into the CodeBuildRunner from event details field.                |
| **exportedVariables**          | string[]                                                                                              | The environment variables to export into the outgoing event once the CodeBuildRunner has finished.    |
| **scriptEnvironmentVariables** | `{ [key: string]: string }`                                                                           | The variables to pass into the codebuild CodeBuildRunner.                                             |
