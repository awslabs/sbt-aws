...
// import { DefaultApplicationPlane, IJobRunner } from '.';
...
//     const provisioningJob: IJobRunner = {
//       name: 'provisioning',
...
//     const deprovisioningJob: IJobRunner = {
//       name: 'deprovisioning',
//       permissions: new PolicyDocument({
//         statements: [
//           new PolicyStatement({
...
//     const coreApplicationPlane = new DefaultApplicationPlane(this, 'CoreApplicationPlane', {
//       eventBus: eventBus,
